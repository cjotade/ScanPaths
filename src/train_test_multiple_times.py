...
def set_params(SUBJECT, TRAIN_IMG_TYPE="natural", TARGET_STEPS_AHEAD=1, is_train=True, load_model=False):
    ...
    params = ParamsParser(
        ...
        timeseries_params,
        model_params,
        RESULTS_FOLDER="../results/FovSOS-FS_DirectPred/", #"../results/MCD/", #"../results/MCDropout/", 
        CHECKPOINTS_FOLDER="../checkpoints/FovSOS-FS_DirectPred/", #"../checkpoints/MCD/", #"../checkpoints/MCDropout/", 
        N_MC_SAMPLES=None,
        is_train=is_train,
        is_save=True,
        is_save_figs=False,
        ...
        for TARGET_STEPS_AHEAD in TARGETS_STEPS_AHEAD:
            ...
            if test_on_rest_images:
                for img_type in params.get_rest_img_types(): 
                    ...
                    imgs = data_processor.get_img_names(return_split=False)
                    scaler = data_processor.get_scaler()
                    # Prediction
